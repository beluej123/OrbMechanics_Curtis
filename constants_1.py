...
AU_ = AU_.to(ureg.km)  # poor technique to help linter :--(
ASEC360 = 1296000.0
...
GM_SUN = GM_SUN.to(ureg.km**3 / ureg.s**2)  # helps linter, so why not...
...
# mars gm [km^3/s^2], Vallado [2] p.1041, tbl.D-3
GM_MARS_KM = 4.305e4 * ureg.km**3 / ureg.s**2
...
def test_constants_c():
    ...
    print(f"GM_SUN = {GM_SUN.magnitude}")
